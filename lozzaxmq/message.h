...
class Message {
public:
    LozzaxMQ& lozzaxmq; ///< The owning LozzaxMQ object
    ...
    /// Constructor
    Message(LozzaxMQ& lmq, ConnectionID cid, Access access, std::string remote)
        : lozzaxmq{lmq}, conn{std::move(cid)}, access{std::move(access)}, remote{std::move(remote)} {}
