...
void LozzaxMQ::rebuild_pollitems() {
    pollitems.clear();
...
void LozzaxMQ::setup_external_socket(zmq::socket_t& socket) {
...
void LozzaxMQ::setup_outgoing_socket(zmq::socket_t& socket, string_view remote_pubkey) {
...
ConnectionID LozzaxMQ::connect_sn(string_view pubkey, std::chrono::milliseconds keep_alive, string_view hint) {
...
ConnectionID LozzaxMQ::connect_remote(string_view remote, ConnectSuccess on_connect, ConnectFailure on_failure,
...
void LozzaxMQ::disconnect(ConnectionID id, std::chrono::milliseconds linger) {
...
LozzaxMQ::proxy_connect_sn(string_view remote, string_view connect_hint, bool optional, bool incoming_only, bool outgoing_only, std::chrono::milliseconds keep_alive) {
...
std::pair<zmq::socket_t *, std::string> LozzaxMQ::proxy_connect_sn(bt_dict_consumer data) {
...
void LozzaxMQ::proxy_close_connection(size_t index, std::chrono::milliseconds linger) {
...
void LozzaxMQ::proxy_expire_idle_peers() {
...
void LozzaxMQ::proxy_conn_cleanup() {
...
void LozzaxMQ::proxy_connect_remote(bt_dict_consumer data) {
...
void LozzaxMQ::proxy_disconnect(bt_dict_consumer data) {
...
void LozzaxMQ::proxy_disconnect(ConnectionID conn, std::chrono::milliseconds linger) {
